...
// Asserts that the telemetry compile-time constants — `ANTHRASPACE_BUILD_IDENTITY`
// and `ANTHRASPACE_POSTHOG_WRITE_KEY` — were substituted into the shipped binary.
...
function findAsar(rootDir) {
  ...
  // (`dist/mac/AnthraSpace.app/Contents/Resources/app.asar` for x64,
  // `dist/mac-arm64/AnthraSpace.app/Contents/Resources/app.asar` for arm64) because
...
// identifiers `ANTHRASPACE_BUILD_IDENTITY` and `ANTHRASPACE_POSTHOG_WRITE_KEY` with their
