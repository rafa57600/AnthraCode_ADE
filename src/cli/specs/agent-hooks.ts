...
export const AGENT_HOOK_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    summary: 'Show whether AnthraSpace-managed agent status hooks are enabled',
  ...
  },
  {
    ...
    summary: 'Disable AnthraSpace-managed agent status hooks and remove local hook entries',
  ...
  {
    path: ['agent', 'hooks', 'on'],
    summary: 'Enable AnthraSpace-managed agent status hooks',
