...
describe('packaged Windows CLI launcher asset', () => {
  it('walks from resources/bin back to the app root before locating AnthraSpace.exe', () => {
    const launcherPath = join(process.cwd(), 'resources', 'win32', 'bin', 'anthraspace.cmd')
