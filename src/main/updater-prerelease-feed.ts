...
const ATOM_FEED_URL = 'https://github.com/rafa57600/AnthraSpace/releases.atom'
const RELEASES_DOWNLOAD_BASE = 'https://github.com/rafa57600/AnthraSpace/releases/download'
...
const TAG_HREF_RE = /href="https:\/\/github\.com\/rafa57600\/AnthraSpace\/releases\/tag\/([^"]+)"/g
