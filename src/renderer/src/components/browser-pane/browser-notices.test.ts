...
describe('browser notice formatting', () => {
  it('formats denied permissions with safe copy', () => {
    ...
    ).toBe('https://example.com asked for camera or microphone access, and AnthraSpace denied it.')
  })
  ...
  it('formats popup outcomes', () => {
    ...
    ).toBe('https://example.com opened a new page in AnthraSpace.')
    ...
    ).toBe('A site tried to open a popup AnthraSpace does not support here.')
  })
