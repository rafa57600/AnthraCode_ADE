...
export type TerminalShortcutPolicy = 'anthraspace-first' | 'terminal-first'
...
export function normalizeTerminalShortcutPolicy(
  ...
  return policy === 'terminal-first' ? 'terminal-first' : 'anthraspace-first'
}
...
export function keybindingIsActiveInContext(
  ...
  if (normalizeTerminalShortcutPolicy(options.terminalShortcutPolicy) === 'anthraspace-first') {
    return true
  }
